...
* Add `Symfony\Component\Mercure\Jwt\WebTokenFactory`, a `web-token/jwt-library`-based alternative `TokenFactoryInterface` implementation for the Mercure protocol 1.0
